...
test("turn 2 reuses session after tool-using turn 1 (no spurious rebuild)", {
  timeout: 120_000,
}, async () => {
  ...
  try {
    ...
    const text2 = await harness.promptAndWait("What was the name you just read? Repeat it.");
