	...
	it("deltas cumulative per-model usage and prices a fallback from served models", () => {
		const prior = {
			"claude-haiku-4-5": {
				...
				webSearchRequests: 0, costUSD: 0.0002, contextWindow: 200_000, maxOutputTokens: 64_000,
				canonicalModel: "claude-haiku-4-5", provider: "firstParty",
			},
		};
		const current = {
			"claude-haiku-4-5": {
				inputTokens: 110, outputTokens: 15, cacheReadInputTokens: 20, cacheCreationInputTokens: 30,
				webSearchRequests: 0, costUSD: 0.0003, contextWindow: 200_000, maxOutputTokens: 64_000,
				canonicalModel: "claude-haiku-4-5", provider: "firstParty",
			},
			"claude-opus-4-8[1m]": {
				inputTokens: 7, outputTokens: 3, cacheReadInputTokens: 2, cacheCreationInputTokens: 1,
				webSearchRequests: 0, costUSD: 0.00025, contextWindow: 1_000_000, maxOutputTokens: 128_000,
